...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (count($resultado) == 1) {
    ...
    $_SESSION['passwordUsuario'] = $contrasena;
...
<head>
  ...
  <title>Iniciar sesión en TUDÚ</title>
</head>

<body>
  <!-- Login -->
  <!-- Pantilla de: Bootstraptor -->
  <section class="pt-5 pb-5 mt-0 align-items-center d-flex bg-dark" style="min-height: 100vh; background-size: cover; background-image: url(./assets/images/tomates-bg.jpg);">
        ...
        <div class="col-12 col-md-5 col-lg-4   h-50 ">
          <div class="card shadow">
            <div class="card-body mx-auto">
              ...
              <h5 class="card-title mt-3 text-center">Iniciar sesión</h5>
              <!-- Linea -->
              <hr class="bg-black">
              ...
              <p class="text-center">¿No tienes cuenta?
                <a href="./registro.php" class="text-secondary">Regístrate</a>
              </p>
            </div>
          </div>
        </div>
